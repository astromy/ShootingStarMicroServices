...
//================================================= Exams Questions ===================================================
    ...
    @PostMapping("updateExamsQuestion")
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<Optional<ExamsQuestionsResponse>> updateExamsQuestion(@RequestBody ExamsQuestionsRequest examsQuestionsRequest) {
        return ResponseEntity.ok(examsQuestionsServiceInterface.updateQuestion(examsQuestionsRequest));
    }

    @PostMapping("deleteExamsQuestion")
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<String> deleteExamsQuestion(@RequestBody ExamsQuestionsRequest examsQuestionsRequest) {
        examsQuestionsServiceInterface.deleteQuestion(examsQuestionsRequest);
