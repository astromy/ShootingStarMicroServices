...
import com.astromyllc.shootingstar.adminpta.config.EmailProcessingException;
import com.astromyllc.shootingstar.adminpta.config.RateLimitExceededException;
...
public class MailUtil {
    ...
    public boolean sendTransactionalEmail(String to, String subject, String htmlContent,String fromEmail) {
