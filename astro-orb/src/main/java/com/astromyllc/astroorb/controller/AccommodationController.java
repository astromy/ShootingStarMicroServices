...
public class AccommodationController {
    ...
    @ResponseBody
    @RequestMapping(value = "getInstitutionAccommodation", method = RequestMethod.POST)
    public ResponseEntity<String> getInstitutionAccommodation(@RequestBody SingleStringRequest jso) throws IOException {
        String url = backendserve + "/api/accommodation/getInstitutionAccommodation";
