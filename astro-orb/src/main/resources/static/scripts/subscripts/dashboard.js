...
<div class="normalheader transition animated fadeIn">
  <div class="hpanel">
    <div class="panel-body">
      ...
      <h2 class="font-light m-b-xs">ORB Dashboard</h2>
      <small>Track system data with just a glance</small>
    </div>
  </div>
</div>
  ...
  <div class="row">
    <div class="col-lg-4">
      <div class="hpanel">
        ...
        <div class="panel-body">
          <div>
            <div id="radarChart" class="chartData"></div>
          </div>
        </div>
      </div>
    </div>
    <div class="col-lg-4">
      <div class="hpanel">
        ...
        <div class="panel-body">
          <div>
            <div id="doughnutChart" class="chartData"></div>
          </div>
        </div>
      </div>
    </div>
    <div class="col-lg-4">
      <div class="hpanel">
        ...
        <div class="panel-body">
          <div>
            <div id="polarOptions" class="chartData"></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-lg-6">
      <div class="hpanel">
        ...
        <div class="panel-body">
          <div>
            <div id="lineOptions" class="chartData"></div>
          </div>
        </div>
      </div>
    </div>
    <div class="col-lg-6">
      <div class="hpanel">
        <div class="panel-heading">
          ...
          Staff Per Department And Age Group
        </div>
        <div class="panel-body">
          <div>
            <div id="barOptions" class="chartData"></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-lg-6">
      <div class="hpanel">
        ...
        <div class="panel-body">
          <div>
            <div id="candleChartOptions" class="chartData""></div>
          </div>
        </div>
      </div>
    </div>
    <div class="col-lg-6">
      <div class="hpanel">
        ...
        <div class="panel-body">
          <div>
            <div id="forceDirectedTreeOption" class="chartData"></div>
          </div>
        </div>
      </div>
    </div>
