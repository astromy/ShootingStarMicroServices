...
(function () {
    ...
    const header = `<div class="panel-body"><div class="panel-body row">
<div class="pull-right col-lg-8"><div class="form-group col-lg-3">
...
<button class="btn btn-primary col-lg-12" type="button" id="reportExportBtn">Download Broadsheet</button>
</div>
<div id="hbreadcrumb" class="col-lg-3"><button class="btn btn-info reportPublishBtn col-lg-12" type="button" id="reportPublishBtn">Publish Report</button></div>
<div id="reportGenerate" class="col-lg-3"><button class="btn btn-success col-lg-12" type="button" id="reportGenerateBtn">Generate</button></div>
</div>
</div>
<div class="row"><div class="col-lg-12 pull-left"><div class="form-group col-lg-2">
<select class="form-control classGroupSelect"><option>Select Class Group</option></select></div>
<div class="form-group col-lg-2"><select class="form-control classSelect"><option>Select Class</option></select></div>
<div class="form-group col-lg-2">
<select class="form-control termSelect">
<option value="0">Select Term</option>
<option value="First Term">First Term</option>
<option value="Second Semester">Second Term</option>
<option value="Third Semester">Third Term</option>
</select>
</div>
