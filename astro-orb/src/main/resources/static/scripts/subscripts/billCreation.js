$(function () {
    ...
    let header = `
        ...
        <div class="modal fade hmodal-info" id="newBillModal" tabindex="-1" role="dialog">
                ...
                <div class="modal-content">
                    <div class="color-line"></div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary left test"><i class="fa fa-plus-square"></i> Add More Bill</button>
    ...
    // Clean up any stray modal backdrops and state left by previous pages
    document.querySelectorAll('.modal-backdrop').forEach(function (el) {
        el.remove();
    });
    document.body.classList.remove('modal-open');
    // Remove any previously injected _financeFeeCollection or _financeBilling scripts
    document.querySelectorAll('script[data-dynamic="true"]').forEach(function (el) {
        el.remove();
    });
