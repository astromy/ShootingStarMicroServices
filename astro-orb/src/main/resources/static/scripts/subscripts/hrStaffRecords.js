                ...
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <div class="text-center m-b-md" id="wizardControls">
                            ...
                            <a class="btn btn-default wizardTabs" data-toggle="tab">Step 2 - Records</a>
...
<div class="p-m tab-pane staffPane active">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary left test"><i class="fa fa-plus-square"></i> Add More Dependants</button>
...
`
    ...
    script14.setAttribute("src", "scripts/_hrStaffRecords.js");
