...
$(function () {
    ...
    let header = `
            <div class="panel-body">
                <div id="hbreadcrumb" class="pull-right">
                    <button class="btn btn-info" type="button" id="modalopn" data-toggle="modal" data-target="#myPromotionsModal">New Class</button>
                </div>
            </div>
    `
    ...
    let classes = `
            ...
            <div class="content animate-panel" id="pagecontent">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        <table id="promotionTable" class="table table-striped table-bordered table-hover" width="100%">
                            <thead>
                                <tr>
                                    <th hidden>id</th>
                                    <th>Current Class</th>
                ...
                <div class="modal fade hmodal-info" id="myPromotionsModal" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="color-line"></div>
                            <div class="modal-header">
                                <h4 class="modal-title">Add Promotion Setting</h4>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-default dismissPromotion" data-dismiss="modal">Close</button>
    ...
    script14.setAttribute("src", "scripts/_promotions.js");
...
el4.setAttribute("class", "form-control m-b promotionOptions");
el4.setAttribute("name", "currentClass");
el4.setAttribute("id", "currentClass");

var el5=document.createElement("option");
el5.innerHTML=("Select Current Class");
...
var eld=document.createElement("select");
eld.setAttribute("class", "form-control m-b promotionOptions1");
eld.setAttribute("name", "targetClass");
eld.setAttribute("id", "targetClass");

var ele=document.createElement("option");
ele.innerHTML=("Select Target Class");
