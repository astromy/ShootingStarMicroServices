$(function () {
    ...
    <div class="content animate-panel" id="pagecontent">
        ...
        <div class="modal fade hmodal-info" id="myadmissionsModal" tabindex="-1" role="dialog">
                ...
                <div class="modal-content">
                    <div class="color-line"></div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary left test"><i class="fa fa-plus-square"></i> Add More Category</button>
