$(function () {
    ...
    daterangepicker(".datpicker1div",".datetimepicker");
    daterangepicker(".datpicker1div2",".datetimepicker2")
...
function admissionsCategory() {
   /* let <div> = `*/
    ...
    el3d.classList.add("col-md-12", "datpicker1div");
    ...
    el3d2.classList.add("col-md-12", "datpicker1div2");
...
function daterangepicker(parent,class2) {
  // Get today's date
