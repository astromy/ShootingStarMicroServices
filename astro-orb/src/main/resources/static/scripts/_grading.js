...
function postdata() {
  ...
  for (var i = 0; i < gradeBrackets.length; i++) {
    var jsonObject = {
      id: id,
      lowerLimit: Number(
        gradeBrackets[i].getElementsByClassName("lowerLimit")[0].value
      ),
  ...
  var interJsonObject = {
    ...
    classPercentage: Number(
      settings.getElementsByClassName("newClassPercentage")[0].value
    ),
    examsPercentage: Number(
      settings.getElementsByClassName("newExamsPercentage")[0].value
    ),
    trailingMark: Number(
      settings.getElementsByClassName("newTrailingMark")[0].value
    ),
    allowedTrails: Number(
      settings.getElementsByClassName("newAllowedTrails")[0].value
    ),
